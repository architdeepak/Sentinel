"""
Detection module for Driver Drowsiness Detection System V5.
Handles face landmark processing, drowsiness metric calculation,
overlay drawing, AND background detection thread.

V5: Added DetectionThread — runs detection in a background thread during
conversation so the LLM gets live drowsiness scores each turn.
Thread-safe via threading.Lock on shared metrics dict.
"""
