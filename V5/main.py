#!/usr/bin/env python3
"""
Driver Drowsiness Detection System V5
...
def run_llm_conversation(tts, stt, llm_assistant, metrics, state, voice_extractor):
    ...
    """
    print("\n" + "=" * 60)
    print("💬 STARTING CONVERSATION (V5 — live detection + voice analysis)")
    print("=" * 60)
...
# =========================
def main():
    """Main function — V5 multi-threaded drowsiness detection system."""
    print("\n" + "=" * 60)
    print("🚗 Driver Drowsiness Detection System V5")
    print("   Multi-threaded: live detection + voice analysis")
