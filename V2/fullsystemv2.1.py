...
# =========================
# SPEECH-TO-TEXT - speech_recognition-based implementation
# =========================
class STTEngine:
    """speech_recognition-based STT using Google's online recognizer.
    This provides a simple, reliable interface for short driver responses.
    Note: Requires internet access for Google recognizer, and PyAudio installed.
    """
    def __init__(self):
    ...
    def cleanup(self):
        """Cleanup resources (no-op for speech_recognition Microphone)."""
        pass
